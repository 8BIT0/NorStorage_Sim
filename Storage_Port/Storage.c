 ...
 */
    ...
    if (new_free_addr < front_free_addr)
    {
...
static Storage_ErrorCode_List Storage_FreeSlot_CheckMerge(uint32_t slot_addr, Storage_FreeSlot_TypeDef *new_freeslot, Storage_BaseSecInfo_TypeDef *p_Sec)
{
    ...
    while (true)
    {
        ...
        {
            STORAGE_INFO("slot merge", "New free slot near ahead the ole one");
        ...
        {
            STORAGE_INFO("slot merge", "New free slot near behind the old one");
